...
namespace Erlang.NET
{
	 ...
	 */
	public OtpErlangList(OtpErlangObject[] elems) : this(elems, 0, elems.Length)
	{
	}
	 ...
	 */
	public OtpErlangList(OtpErlangObject[] elems, OtpErlangObject lastTail) : this(elems, 0, elems.Length)
	{
	...
	private class SubList : OtpErlangList
	{
	    ...
	    public SubList(OtpErlangList parent, int start) : base()
	    {
		this.parent = parent;
		this.start = start;
	    }
