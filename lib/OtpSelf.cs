...
namespace Erlang.NET
{
	 ...
	 * 
	 */
	public OtpSelf(String node) : this(node, defaultCookie, 0)
	{ 
	}
	 ...
	 */
	public OtpSelf(String node, String cookie) : this(node, cookie, 0)
	{
	}

	public OtpSelf(String node, String cookie, int port) : base(node, cookie)
	{
