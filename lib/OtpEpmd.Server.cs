...
namespace Erlang.NET
{
        ...
        public class OtpPublishedNode : AbstractNode
	{
	    ...
	    public OtpPublishedNode(String node) : base(node, String.Empty)
	    {
	    }
	}
	...
	public OtpEpmd() : base("OtpEpmd", true)
	{
	...
	private class OtpEpmdConnection : ThreadBase
	{
	    ...
	    public OtpEpmdConnection(OtpEpmd epmd, TcpClient sock) : base("OtpEpmd.OtpEpmdConnection", true)
	    {
		this.epmd = epmd;
