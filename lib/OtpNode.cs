...
namespace Erlang.NET
{
	 ...
	 * 
	 */
	public OtpNode(String node) : this(node, defaultCookie, 0)
	{
	}
	 ...
	 * 
	 */
	public OtpNode(String node, String cookie) : this(node, cookie, 0)
	{
	}
	 ...
	 * 
	 */
	public OtpNode(String node, String cookie, int port) : base(node, cookie)
	{
	    init(port);
	}
	...
	public class Acceptor : ThreadBase
	{
	    ...
	    public Acceptor(OtpNode node, int port) : base("OtpNode.Acceptor",true)
	    {
		this.node = node;
