...
namespace Erlang.NET
{
	 ...
	 * error
	 */
	protected AbstractConnection(OtpLocalNode self, BufferedTcpClient s) : base("receive", true)
	{
	    this.self = self;
	    peer = new OtpPeer();
	    socket = s;
	 ...
	 * error.
	 */
	protected AbstractConnection(OtpLocalNode self, OtpPeer other) : base("receive", true)
	{
	    peer = other;
	    this.self = self;
	    socket = null;
